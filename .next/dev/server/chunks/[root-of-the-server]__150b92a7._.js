...
"[project]/app/api/auth/cambiar-password/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const usuarioIndex = usuarios.findIndex((row)=>row && row[0] === departamento && row[1] === passwordActual);
        if (usuarioIndex === -1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__150b92a7._.js.map