...
"[project]/app/api/lib/drive-upload.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "subirComprobanteImpuesto",
    ()=>subirComprobanteImpuesto
]);
...
const oauth2Client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["google"].auth.OAuth2(process.env.GOOGLE_OAUTH2_CLIENT_ID, process.env.GOOGLE_OAUTH2_CLIENT_SECRET);
oauth2Client.setCredentials({
    refresh_token: process.env.GOOGLE_OAUTH2_REFRESH_TOKEN
});
const driveClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["google"].drive({
    version: "v3",
    auth: oauth2Client
});
...
async function subirComprobanteImpuesto({ departamento, impuesto, mes, comprobante }) {
    ...
    const stream = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"].from(buffer);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$lib$2f$drive$2d$upload$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/lib/drive-upload.js [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        if (comprobante) {
            try {
                driveResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$lib$2f$drive$2d$upload$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subirComprobanteImpuesto"])({
                    departamento,
                    impuesto,
                    mes,
                    comprobante
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ed2b062._.js.map